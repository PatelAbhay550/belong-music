      ...
      return (
        <div className="text-center py-20">
          <div className="mb-6">
            ...
            <p className="text-gray-500 mb-6">Find your favorite songs, albums, and artists</p>
            {isMobile && (
              <p className="text-sm text-gray-400">Use the search box above to get started</p>
            )}
          </div>
        </div>
      );
