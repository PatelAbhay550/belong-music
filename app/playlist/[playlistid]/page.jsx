...
const PlaylistDetails = () => {
  ...
  const { playSong, addToQueue, isPlaying, currentSong } = useAudio();
  ...
  const handlePlayAll = () => {
    if (songs.length > 0) {
      console.log('Playing all songs, starting with:', songs[0].name);
      playSong(songs[0], songs, 0);
      toast.success(`Playing all songs from playlist`);
    }
  };
                  ...
                  <div className="flex-1 space-y-4 text-center lg:text-left">
                    ...
                    <div className="flex flex-col space-y-3 pt-4">
                      ...
                      <button
                        ...
                        className="flex items-center justify-center space-x-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-md transition-colors text-white font-medium w-full"
                      >
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <button className="flex items-center justify-center space-x-2 px-4 py-2 bg-gray-100 text-gray-700 hover:bg-gray-200 rounded-md transition-colors">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                      ...
                      <div className="col-span-1 md:col-span-4 flex items-center space-x-3">
                        ...
                        <button
                          ...
                          className="md:hidden flex-shrink-0 p-2 hover:bg-gray-200 rounded-full transition-colors"
                        >
